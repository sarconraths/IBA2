class Overloading
{
  public static void main(String[] args)
  {
    ...
    System.out.printf("1. Rechteck:%nBreite: %d%nLaenge: %d%n",
                       specialRect.width, specialRect.length);
    System.out.printf("2. Rechteck:%nBreite: %d%nLaenge: %d%n",
                       anotherRect.width, anotherRect.length);

    specialRect.resize(3,7);
    System.out.printf("1. Rechteck (veraendert):%nBreite: %d%nLaenge: %d%n",
                       specialRect.width, specialRect.length);
    anotherRect.resize(5.0);
    System.out.printf("2. Rechteck (vergroessert):%nBreite: %d%nLaenge: %d%n",
                       anotherRect.width, anotherRect.length);
  }
}
