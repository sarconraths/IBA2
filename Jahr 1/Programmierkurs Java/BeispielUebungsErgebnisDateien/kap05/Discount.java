class Discount
{
  public static void main(String[] args)
  {
    ...
    invoiceAmount = Double.parseDouble(args[0]); //Programmparameter als Fliess-
                                                 //kommazahl auswerten und
                                                 //in invoiceAmount speichern
    if (invoiceAmount > 1000)
    {
      invoiceAmount -= invoiceAmount * 0.04;     //Rabatt wird berechnet und vom
